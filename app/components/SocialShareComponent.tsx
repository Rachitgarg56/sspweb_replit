...
const SocialShareComponent = ({ url }: Props) => {
    const handleCopy = () => {
    ...
    return (
        <div className='flex flex-col sm:flex-row items-center justify-center text-[var(--brown-light)] mt-4'>
            <div className='sm:pr-6 py-1 h-full font-medium text-[13px] font-inter flex items-center'>SHARE</div>

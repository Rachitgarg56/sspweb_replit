...
export default function ResourceLayout({ children }: { children: React.ReactNode }) {
      ...
      const breadcrumbs = [
        ...
        { title: "Panchangam", link: "/gallery/downloadables/panchangam" },
      ]
    ...
    return (
        <div className="">
            ...
            <section className="p-4 bg-[--gray-100] pb-12">
                <div className="max-w-[1175px] m-auto flex flex-col gap-4 md:mb-12">
                    <div className="mt-4">
                        <BreadCrumbs breadcrumbs={breadcrumbs} breadcrumbsSeperator={breadcrumbsSeperator} />
                    </div>
                    
                    <div className="items-center">
                        <h1 className="text-center font-pt-serif text-4xl mb-5 text-[var(--resources)] w-full">Panchangam</h1>
                    </div>

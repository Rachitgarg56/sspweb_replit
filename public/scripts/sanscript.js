...
(function(Sanscript) {
    ...
    (function() {
        ...
        // IAST variant, which supports Dravidian short 'e' and 'o'.
        var iast_dravidian = cheapCopy(schemes.iast);
        iast_dravidian.vowels = 'a ā i ī u ū ṛ ṝ ḷ ḹ e ē ai o ō au'.split(' ');
        iast_dravidian.vowel_marks = iast_dravidian.vowels.slice(1);
        allAlternates.iast_dravidian = allAlternates.iast;
        Sanscript.addRomanScheme('iast_dravidian', iast_dravidian);
    }());
